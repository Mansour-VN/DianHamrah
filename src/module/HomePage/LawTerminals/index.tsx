                ...
                <div className="container flex flex-row flex-wrap items-center">
                    <div className="md:w-1/2 flex flex-col md:flex-row">
                        <div className="flex flex-col p-2">
                            <CervicesCard backImg={supportPNG} icon={supportIcon} title="حمایت کردن"
                                   content="تشخیص موتور نکته بعدی در مورد متن ساختگی لورم ایپسوم این است که بعضی از طراحان وبسایت و..." path="/"/>
                            <CervicesCard backImg={keepingPNG} icon={keepingIcon} title="نگهداری"
                                   content="تشخیص موتور نکته بعدی در مورد متن ساختگی لورم ایپسوم این است که بعضی از طراحان وبسایت و..." path="/"/>
                        </div>
                        <div className="flex flex-col p-2 md:mt-16">
                            <CervicesCard backImg={planingPNG} icon={planingIcon} title="برنامه ریزی"
                                   content="تشخیص موتور نکته بعدی در مورد متن ساختگی لورم ایپسوم این است که بعضی از طراحان وبسایت و..." path="/"/>
                            <CervicesCard backImg={managementPNG} icon={managementIcon} title="مدیریت"
                                   content="تشخیص موتور نکته بعدی در مورد متن ساختگی لورم ایپسوم این است که بعضی از طراحان وبسایت و..." path="/"/>
                        </div>
                    </div>
