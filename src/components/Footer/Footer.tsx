...
const Footer = () => {
    return (
        <div className='w-full bg-gray-700 flex items-center justify-center relative flex-col'>
            ...
            <div id='footerr' className='flex flex-col gap-2 md:flex-row md:container md:gap-4 md:absolute md:h-80 z-10'>
                ...
                <div id='Link' className='flex flex-col gap-5 md:w-1/3 md:p-0 p-4' >
                    <h3 className='border-b-4 border-dotted border-orange-500/100 w-1/3  text-white p-2 font-extrabold'>سایت‌های مربوطه</h3>
                ...
                <div id='location social' className='flex flex-col md:w-1/3 md:p-0 p-4'>
                    <h3 className='border-b-4 border-dotted border-orange-500/100 w-1/3  text-white p-2 font-extrabold'>ارتباط باما </h3>
